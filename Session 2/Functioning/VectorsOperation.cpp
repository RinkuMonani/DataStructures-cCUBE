...
int main(){
    ...
    v.insert(v.begin(),40); // vectorName.insert(position_iterator,value) v = {10,20,30,40};
    v.insert(v.begin()+2,25); //you must've guessed - v = {10,20,25,30,40};
    //v.emplace(v.begin(),5) ; // v = {5,10,20,25,30,40};
    //remove element from back
    v.pop_back(); // v = {5,10,20,25,30}
    v.erase(v.end()); // v = {5,10,20,25}
    //remove from front and any poisition
    v.erase(v.begin()); // v = {10,20,25}
    v.erase(v.begin()+1);// yes you're right v = {10,25}
